...
<head>
  ...
  <title>Login SMK Ma'arif | Dashboard</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url().'index.php/walikelas/login'; ?>" method="post">
      ...
      <div class="text-center" style="color: #af0600;"> <?php $info = $this->session->flashdata('info');
        ...
        <div class="box-footer">
                <a href="<?php echo base_url().'index.php/home/login' ?>" class="btn btn-default"><i class="fa fa-university"></i> Login Guru</a>
