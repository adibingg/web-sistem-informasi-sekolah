...
<head>
  ...
  <title>Guru SMK Ma'arif | Dashboard</title>
...
<div class="wrapper">
  <header class="main-header">
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>HALAMAN GURU</b> | SMK MA'ARIF</span>
    </a>
    ...
    <section class="sidebar">
      <form action="#" method="get" class="sidebar-form">
        ...
        <ul class="sidebar-menu">
         <li>
          <a href="<?php echo base_url().'guru/dashboard/' ?>"><i class="glyphicon glyphicon-dashboard"></i> <span>DASHBOARD</span></a></li></a>
        </li>
        <li>
          <a href="<?php echo base_url().'guru/nilai' ?>"><i class="glyphicon glyphicon-edit"></i> <span>NILAI SISWA</span></a></li></a>
        </li>
        <li>
          <a href="<?php echo base_url().'guru/upload_materi' ?>"><i class="glyphicon glyphicon-upload"></i> <span>UPLOAD MATERI PELAJARAN</span></a></li></a>
        </li>
