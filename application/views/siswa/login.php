...
<head>
  ...
  <link href="<?php echo base_url().'assets/img/logo.png' ?>" rel="shortcut icon" type="image/ico" /> 
...
<div class="box-header">
  <div class="box-body">
    <div class="alert alert-success" style="background-color: #272; color: #000;">
      <div class="login-logo">
        <img src="<?php echo base_url().'assets/'?>img/logo-header.png" alt=""> SMK MA'ARIF 1 KALIREJO
      </div>
    </div>
  </div>
</div>
...
<div class="login-box" style="margin-top: 4%;">
    ...
    <form action="<?php echo base_url().'siswa/login' ?>" method="post">
      ...
      <div class="box-body">
              <div class="alert alert-success" style="background-color: #272; color: #000;">
                <p style="color: #fff;"> Username dan Password menggunakan nama depan, jika telah masuk ke halaman siswa harap segera di ubah</p>
                <p style="color: #fff;"><i class="fa fa fa-circle-o"></i> Login ke halaman siswa untuk melihat informasi nilai</p>
                <p style="color: #fff;"><i class="fa fa fa-circle-o"></i> Mengunduh materi pelajaran</p>
                <p style="color: #fff;"><i class="fa fa fa-circle-o"></i> Melihat biodata siswa</p>
              </div>
          </div>
<div class="box-footer">
  <center><b> &copy SMK Ma'arif 1 Kalirejo Lampung Tengah 2017</b></center>    
</div>
</body>
