...
<head>
  ...
  <link rel="shortcut icon" type="image/icon" href="<?php echo base_url().'assets/' ?>img/logo.png"/>
     ...
     <ul class="sidebar-menu">
        <li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?php echo base_url().'admin/gallery' ?>"><i class="fa fa-circle-o"></i> GALERY</a></li>
              <li><a href="<?php echo base_url().'admin/pengumuman' ?>"><i class="fa fa-circle-o"></i> PENGUMUMAN</a></li>
               <li><a href="<?php echo base_url().'admin/agenda' ?>"><i class="fa fa-circle-o"></i> AGENDA SEKOLAH</a></li>
               <li><a href="<?php echo base_url().'admin/download' ?>"><i class="fa fa-circle-o"></i> LIST DOWNLOAD</a></li>
            </ul>
          </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url().'admin/data_alumni' ?>"><i class="fa fa-circle-o"></i> DATA ALUMNI</a></li>
       ...
       <li>
        ...
        <li>
          <a href="<?php echo base_url().'admin/buku_tamu' ?>"><i class="fa fa-commenting"></i> <span>BUKU TAMU</span></a>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'admin/baner' ?>"><i class="fa fa-circle-o"></i> BANER</a></li>
            <li><a href="<?php echo base_url().'admin/link_terkait' ?>"><i class="fa fa-circle-o"></i> MANAJEMEN ADMIN</a></li>
          </ul>
        </li>
    </section>
  </aside> 
