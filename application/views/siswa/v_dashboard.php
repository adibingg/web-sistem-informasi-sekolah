...
<head>
  ...
  <title>Halaman Siswa | SMK Ma'arif 1 Kalirejo</title>
...
<div class="wrapper">
  <header class="main-header">
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SISWA</b> | SMK MA'ARIF</span>
    </a>
    ...
    <section class="sidebar">
     <ul class="sidebar-menu">
        <li>
         ...
         <li>
          <a href="<?php echo base_url().'siswa/logout'?>"><i class="fa fa-sign-out"></i> <span>LOGOUT</span></a></li></a>
        </li>
    </section>
  </aside> 
</body>
