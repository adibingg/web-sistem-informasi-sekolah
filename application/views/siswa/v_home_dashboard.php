        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <a class="btn btn-primary btn-flat" href="<?php echo base_url().'siswa/nilai' ?>"> Lihat Data <i class="glyphicon glyphicon-chevron-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-4 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-number">SILABUS</span>
              <span class="info-box-text">Lihat informasi materi pelajaran</span>
              <a class="btn btn-primary btn-flat" href="<?php echo base_url().'siswa/materi_pelajaran' ?>"> Lihat Data <i class="glyphicon glyphicon-chevron-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-4 col-xs-12">
